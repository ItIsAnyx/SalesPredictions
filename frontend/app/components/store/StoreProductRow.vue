...
<template>
    <tr class="hover:bg-surface-container-low transition-colors">
        ...
        <td class="px-md py-md">
            <div class="flex items-center gap-sm">
                <div class="flex items-end gap-[2px] h-6">
                    <div v-for="(_, i) in 5" :key="i" class="w-1.5 rounded-sm transition-all" :style="barStyle(i)" />
                </div>
        ...
        <td class="px-md py-md">
            <button class="px-md py-sm  bg-secondary text-white text-sm font-bold rounded-lg hover:opacity-90"
